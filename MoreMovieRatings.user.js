    ...
    if (host === "movie.douban.com") {
        ...
        GM_xmlhttpRequest({
            ...
            onload: function(response) {
                ...
                var sectl = document.querySelector("#interest_sectl");
                // IMDb
                if (data.imdbRating !== "N/A") {
                    sectl.insertAdjacentHTML('beforeend',
                        "<div style='-webkit-filter: hue-rotate(90deg); filter: hue-rotate(90deg)'>" +
                ...
                if (data.Metascore !== "N/A") {
                    ...
                    sectl.insertAdjacentHTML('beforeend',
                        "<br>Metascore: <span style='height: 24px; width: 24px; line-height: 24px; background-color: " + 
                        metacolor + "; color: #fff; vertical-align: middle; display: inline-block; text-align: center; font-weight: bold'>" + data.Metascore + "</span>"
                    );
                }

                // Rotten Tomatoes
                if (data.tomatoMeter !== "N/A" || data.tomatoUserMeter !== "N/A") {
                    sectl.insertAdjacentHTML('beforeend', "<br>");
                    var tomatoimg = {
