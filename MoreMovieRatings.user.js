        ...
        GM_xmlhttpRequest({method: 'GET', url: "http://www.omdbapi.com/?i=" + id + "&tomatoes=true", onload: function(response) {
            ...
            if (data.tomatoMeter !== "N/A" || data.tomatoUserMeter !== "N/A") {
                ...
                if (data.tomatoUserMeter !== "N/A") {
                    ...
                    sectl.append("<span class='tomatoimg tomato' style='background: url(data:image/png;base64," + tomatoimg[userimage] + ") no-repeat'></span><span class=tomato>" + data.tomatoUserMeter + "%</span>");
                }
